...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                   "ikt104testing"                                                                                  // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                   WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                       "Redmi"                                                                                          // set by application[*]
...
#define MBED_CONF_RTOS_MAIN_THREAD_STACK_SIZE                                   16384                                                                                            // set by application[DISCO_L475VG_IOT01A]
